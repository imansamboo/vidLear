...
["یزد" => "احمدآباد"],
         ...
         $proviences = array();
         foreach ($provienceCityArray as $index => $value){
             foreach ($value as $provience => $city){
                 if(!in_array($provience, $proviences)){
                     $proviences[] = $provience;
                 }
             }
         }
         count($proviences);
         ...
         $i = 0;
         foreach ($provienceCityArray as $key => $value){
             foreach ($value as $provience => $city){
                 $i++;

                 City::create(
                     [
                         'province_id' => Province::where('name', '=', $provience)->first()->id,
                         'name' => $city,
                         'id' => $i,
                     ]
                 );
         ...
         echo count($provienceCityArray);
         print_r($provienceCityArray);
     }
}
