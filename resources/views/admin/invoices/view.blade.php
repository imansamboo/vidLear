          ...
          <table class="table table-hover">
            ...
            @foreach($invoice->items as $invoiceItem)
              <tr>
                ...
                <td>
{{--
                  {!! Form::model($invoiceItem, ['route' => url('admin/invoiceItems/destroy'). '/invoices/' . $invoice->id . '/items/'. $invoiceItem->id], 'method' => 'delete', 'class' => 'form-inline'] ) !!}
--}}
          ...
          <a href="{{ route('admin.invoiceItems.create')}}/{{$invoice->id}}" class="btn btn-xs btn-success" style="margin-right: 2%;">Add Item</a>
