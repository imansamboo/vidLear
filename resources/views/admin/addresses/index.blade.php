        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {!! Form::model($address, ['route' => ['admin.addresses.destroy', $address], 'method' => 'delete', 'class' => 'form-inline'] ) !!}
                 <a href="{{ route('admin.addresses.edit', $address->id)}}" class="btn btn-xs btn-success" style="margin-right: 2%;">Edit</a>
